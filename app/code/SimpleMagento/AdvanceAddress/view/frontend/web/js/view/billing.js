define([
    ...
    'SimpleMagento_AdvanceAddress/js/model/billing-address/form-popup-state',
    'SimpleMagento_AdvanceAddress/js/action/edit-billing-address',
    ...
    return Component.extend({
        defaults: {
            template: 'SimpleMagento_AdvanceAddress/billing',
            billingFormTemplate: 'SimpleMagento_AdvanceAddress/billing-address/form'
        },
