...
class Save extends Action
{
    ...
    public function execute()
    {
        ...
        $saveResponse = $this->saveConfigs([
            ...
            'wesupply_api/step_1/wesupply_connection_status' => 1,
            'wesupply_api/step_1/wesupply_client_id' => $this->getClientIdFromAuth($authResponse) ?? '',
            'wesupply_api/step_1/wesupply_client_secret' => $this->getClientSecretFromAuth($authResponse) ?? ''
    ...
    private function validateParams()
    {
        ...
        if ($this->params['ClientName'] !== $this->_helper->getClientName()) {
            $this->setError(__('WeSupply SubDomain does not match.'));
