...
return [
    'modules' => [
        ...
        'SimpleMagento_AddBulkProduct' => 0,
        'SimpleMagento_AdvanceAddress' => 0,
        'SimpleMagento_Attribute' => 0,
        'SimpleMagento_CartCustom' => 0,
        'SimpleMagento_CollapseWidget' => 0,
        'SimpleMagento_CustomAdmin' => 0,
        'SimpleMagento_CustomCronJob' => 0,
        'SimpleMagento_CustomReport' => 0,
        'SimpleMagento_CustomSort' => 0,
        'SimpleMagento_CustomTab' => 0,
        'SimpleMagento_CustomWishlist' => 0,
        'SimpleMagento_CustomerAttribute' => 0,
        'SimpleMagento_CustomerEmail' => 0,
        'SimpleMagento_CustomerProductPrice' => 0,
        'SimpleMagento_Database' => 0,
        'SimpleMagento_FirstModule' => 0,
        'SimpleMagento_HeaderChange' => 0,
        'SimpleMagento_HelloWorld' => 0,
        'SimpleMagento_KrishTech' => 0,
        'SimpleMagento_PhoneValid' => 0,
        'SimpleMagento_PreviewPopup' => 0,
        'SimpleMagento_ProductExtension' => 0,
        'SimpleMagento_ProductModal' => 0,
        'SimpleMagento_ProductPrice' => 0,
        'SimpleMagento_ProductTabs' => 0,
        'SimpleMagento_QuestionAnswer' => 0,
        'SimpleMagento_ReviewCustomer' => 0,
        'SimpleMagento_RewardPoint' => 0,
        'SimpleMagento_Tools' => 1,
        'SimpleMagento_UsernameSignin' => 0,
        'Amazon_Core' => 1,
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
        'DEG_CustomReports' => 0,
